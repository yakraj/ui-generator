        ...
        <div className="data-contents">
          ...
          <div className="neo-cont">
            <div className="flex">
              ...
              <div
                onClick={() => (Element.style.justifyContent = "space-between")}
                className={FlexControlBox}
              >
                <img
                  width={40}
              ...
              <div
                onClick={() => (Element.style.justifyContent = "space-around")}
                className={FlexControlBox}
              >
                <img
                  width={40}
              ...
              <div
                onClick={() => (Element.style.justifyContent = "space-evenly")}
                className={FlexControlBox}
              >
                <img
                  width={40}
              ...
              <div className="wid-100-center">
                ...
                <div className="wid-100-center">
                  <div className={padding}>
                    <input
                      onFocus={(e) => e.target.select()}
                      onChange={(e) => (Element.style.padding = e.target.value)}
                      type="text"
                    />
                  </div>
                </div>
            ...
            <div className="wid-50">
              ...
              <div className="wid-100-center">
                <div className={padding}>
                  <input
                    onFocus={(e) => e.target.select()}
                    onChange={(e) => (Element.style.marginTop = e.target.value)}
                    type="text"
                  />
                </div>
              </div>
          ...
          <div className="text-edit-cont neo-cont">
            ...
            <div className="flex">
              <div className="wid-50">
                ...
                <select
                  ...
                  id="displayDropdown"
                  onChange={(e) =>
                    Element ? (Element.style.fontWeight = e.target.value) : null
                  }
                >
            ...
            <div className="flex">
              ...
              <div className="wid-50">
                ...
                <select
                  onChange={(e) =>
                    Element ? (Element.style.fontFamily = e.target.value) : null
                  }
                  id="font-family"
                >
